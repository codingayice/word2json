...
- Branch: `phase-118-text-run-small-caps-off`
- Implementation commit: `8767d49 feat: add phase 118 text run small caps off`
- Remote: `origin/phase-118-text-run-small-caps-off`

...
- Branch: `phase-126-text-run-spec-vanish`
- Implementation commit: `54584b1 feat: add phase 126 text run spec vanish`
- Remote: `origin/phase-126-text-run-spec-vanish`

...
- Branch: `phase-164-section-mirror-margins`
- Feature commit: `bdcf394 feat: add phase 164 section mirror margins`
- Verification:
  - `npm test -- tests/docx-core.test.ts -t "section mirror margins"`: 2 passed
  - `npm test`: 470 passed
  - `npm run build`: exit 0
  - `git diff --check`: exit 0 with LF/CRLF warnings
- PR: https://github.com/codingayice/word2json/pull/new/phase-164-section-mirror-margins

...
- Branch: `phase-67-superscript-control-properties`
- Implementation commit: `7cf385e feat: add phase 67 superscript control properties`
- Remote: `origin/phase-67-superscript-control-properties`

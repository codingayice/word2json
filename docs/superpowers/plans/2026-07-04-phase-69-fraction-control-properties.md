...
- Branch: `phase-69-fraction-control-properties`
- Implementation commit: `34045ab feat: add phase 69 fraction control properties`
- Remote: `origin/phase-69-fraction-control-properties`

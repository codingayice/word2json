...
- Branch: `phase-71-nary-control-properties`
- Implementation commit: `042d4af feat: add phase 71 nary control properties`
- Remote: `origin/phase-71-nary-control-properties`

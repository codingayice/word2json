...
- Branch: `phase-75-bar-control-properties`
- Implementation commit: `01ccdcf feat: add phase 75 bar control properties`
- Remote: `origin/phase-75-bar-control-properties`

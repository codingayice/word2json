...
- Branch: `phase-76-function-control-properties`
- Implementation commit: `bd47f29 feat: add phase 76 function control properties`
- Remote: `origin/phase-76-function-control-properties`

...
- Branch: `phase-82-phantom-control-properties`
- Implementation commit: `b1b2649 feat: add phase 82 phantom control properties`
- Remote: `origin/phase-82-phantom-control-properties`

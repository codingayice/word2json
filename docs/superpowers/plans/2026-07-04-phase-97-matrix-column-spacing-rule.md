...
- Branch: `phase-97-matrix-column-spacing-rule`
- Implementation commit: `e907ca7 feat: add phase 97 matrix column spacing rule`
- Remote: `origin/phase-97-matrix-column-spacing-rule`
